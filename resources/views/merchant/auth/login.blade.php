            ...
            <div class="form-wrapper">
                ...
                <form action="{{ route('merchant.login') }}" method="POST" class="cmn-form mt-30">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="email" class="form-control" id="username" value="{{ old('username') }}" placeholder="@lang('Enter your username')">
                        <input type="email" name="email" class="form-control" id="email" value="{{ old('email') }}" placeholder="@lang('Enter your email')">
                    </div>
                    <div class="form-group">
